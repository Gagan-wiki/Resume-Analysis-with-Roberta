...
def extract_keywords(text, top_n=10):
    ...
    stopwords = {"with", "that", "this", "have", "from", "they", "will", "been", "were",
                 "their", "what", "when", "which", "your", "into", "more", "also", "about",
                 "such", "than", "then", "some", "would", "there", "through", "experience",
                 "work", "team", "years", "using", "strong", "ability", "skills", "required"}
